...
categories:
    - hydrocarbons
weight: 13
summary: "This unit explains the classification, structure, and properties of hydrocarbons including alkanes, alkenes, alkynes, and aromatic compounds. It covers preparation methods and important reactions such as substitution, addition, oxidation, and combustion reactions. The chapter also discusses aromaticity, petroleum products, and the industrial importance of hydrocarbons."
...
| Molecular Formula | Structural Formula | Bond line Formula | IUPAC name | Common Name |
|---|---|---|---|---|
| \( \mathrm{C_4H_{10}} \) | \( \mathrm{CH_3-CH_2-CH_2-CH_3} \) | | butane | n-butane |
| | \( \mathrm{CH_3-CH-CH_3} \) | | 2-methylpropane | iso-butane |
...
To begin, draw the carbon backbone of the straight chain-isomer: C-C-C-C-C

Determine the carbon backbone structure of the other isomers by arranging the carbon atoms in the other way.

Fill in all the hydrogen atoms so that each carbon forms four bonds: \( \mathrm{CH_3-CH_2-CH_2-CH_2-CH_3} \) and \( \mathrm{CH_3-CH-CH-CH_3} \) with \( \mathrm{CH_3} \) groups.

Write the structural formula and carbon skeleton formula for all possible chain isomers of \( \mathrm{C_6H_{14}} \) (Hexane).
...
\[
\mathrm{CH_3-CH=CH_2 + H_2 \xrightarrow{Pt} CH_3-CH_2-CH_3} \quad \text{(propene → propane)}
\]

\[
\mathrm{CH_2=CH_2 + H_2 \xrightarrow{Ni \ 298K} CH_3-CH_3} \quad \text{(ethene → ethane)}
\]

\[
\mathrm{CH_3-C \equiv CH + 2H_2 \xrightarrow{Pt} CH_3-CH_2-CH_3} \quad \text{(prop-1-yne → propane)}
\]
...
\[
2\mathrm{CH_3COONa} + 2\mathrm{H_2O} \xrightarrow{\text{Electrolysis}} \mathrm{CH_3-CH_3} + 2\mathrm{CO_2} + \mathrm{H_2} + 2\mathrm{NaOH}
\]
...
\[
\mathrm{CH_3-CH_2-CH_2-Cl + 2[H] \xrightarrow{Zn/HCl} CH_3-CH_2-CH_3 + HCl} \quad \text{(chloro propane → propane)}
\]
...
|---|---|
| Solubility | insoluble in \( \mathrm{H_2O} \), soluble in non polar solvents |
| Density | Less dense than \( \mathrm{H_2O} \), float on top of \( \mathrm{H_2O} \) |
| Boiling point | Increases as carbon chain length increases, decreases with increase in degree of branching |
...
\[
\mathrm{CH_3-CH_2-CH_2-CH_2-CH_3 \xrightarrow{AlCl_3/HCl \ 298K} CH_3-CH-CH_2-CH_3 \ (with \ CH_3 \ group)}
\]
...
|---|---|---|
| 1 | \( \mathrm{CH_3-CH=CH_2} \) | propene |
| 2 | \( \mathrm{CH_3-CH_2-CH=CH_2} \) | but-1-ene |
| 3 | \( \mathrm{CH_3-CH=CH-CH_3} \) | but-2-ene |
| 4 | \( \mathrm{CH_2=C-CH_3} \) with \( \mathrm{CH_3} \) | 2-methyl prop-1-ene |
| 5 | \( \mathrm{CH_2=CH-CH-CH_2-CH_3} \) with \( \mathrm{CH_3} \) | 3-methyl pent-1-ene |
...
(iii) \( \mathrm{CH_2=C-CH_3} \) (with \( \mathrm{CH_3} \)) 2-methyl prop-1-ene
...
At anode: \( \mathrm{KOOC-CH_2-CH_2-COOK \rightarrow CH_2=CH_2 + 2CO_2 + 2K^+ + 2e^-} \)
...
| CODE | TYPE | NAME | EXAMPLES |
|---|---|---|---|
| 1 | PET | Polyethylene terephthalate | Soft drinks bottles, jars, vegetable oil bottle |
| 2 | HDPE | High-density polyethylene | Milk, water and juice containers |
| 3 | PVC | Polyvinyl chloride | Shampoo bottles, plastic pipes |
| 4 | LDPE | Low density polyethylene | Sandwich bags, grocery bags |
| 5 | PP | Polypropylene | Straws, diaper, toys |
| 6 | PS | Polystyrene | Disposable utensil, foam cups |
| 7 | Other | Multilayer plastics | Various flexible item |
...
|---|---|
| \( \mathrm{CH_3-C \equiv CH} \) | Propyne |
| \( \mathrm{CH_3-CH_2-C \equiv CH} \) | but-1-yne |
| \( \mathrm{CH_3-C \equiv C-CH_3} \) | but-2-yne |
| \( \mathrm{CH_3-CH-C \equiv CH} \) (with \( \mathrm{CH_3} \)) | 3-methyl but-1-yne |
...
1-Butyne → 2-Bromobut-1-ene → 2,2-Dibromobutane
...
|---|---|
| 1. Benzene | (i) Benzene is a planar molecule<br>(ii) It has six delocalised \( \pi \) electrons<br>(iii) \( 4n + 2 = 6 \)<br>\( 4n = 6 - 2 \)<br>\( n = 1 \)<br>It obeys Hückel's \( (4n+2) \pi \) electron rule with n = 1. Hence, benzene is aromatic. |
| 2. Cyclopentadienyl anion | (i) Cyclopentadienyl anion has a planar ring structure<br>(ii) It has 6 delocalised electrons<br>(iii) \( 4n + 2 = 6 \)<br>\( n = 1 \)<br>It obeys Hückel's \( (4n+2) \pi \) electron rule with n = 1. Hence, it is aromatic. |
| 3. Furan | (i) Furan has a planar ring structure<br>(ii) It has 6 delocalised electrons<br>(iii) \( 4n+2 = 6 \)<br>\( n=1 \)<br>It obeys Hückel's \( (4n+2) \pi \) electron rule with n = 1. Hence, it is aromatic. |
| 4. Cyclopentadiene | (i) It has planar structure<br>(ii) It has four \( \pi \) electrons but the \( \pi \) electrons are not delocalised and hence it is not an aromatic compound |
| 5. Cyclooctatetraene | Molecule is non-planar and hence it is not an aromatic compound |
| 6. Cyclopropenyl cation | (i) Cyclopropenyl cation has planar structure<br>(ii) It has 2 delocalised \( \pi \) electrons<br>(iii) \( 4n + 2 = 2 \)<br>\( 4n = 0 \)<br>\( n = 0 \) (an integer)<br>and hence it is an aromatic compound |
